...
3. **Marks every draft** — each pre-filled slide carries a `DRAFT — CONFIRM OR CORRECT` badge, slide notes carry data provenance, and each part ends with `YOUR INPUT` slides of lettered questions with answer boxes. Unknowns become questions, never invented facts.
